# PAYJPv2::PaymentFlowDataRequestOutput
...
| **meta_data** | [**Hash&lt;String, MetadataValue&gt;**](MetadataValue.md) | キーバリューの任意のデータを格納できます。&lt;a href&#x3D;\&quot;https://docs.pay.jp/v2/metadata\&quot;&gt;詳細はメタデータのドキュメントを参照してください。&lt;/a&gt; | [optional] |
...
instance = PAYJPv2::PaymentFlowDataRequestOutput.new(
  capture_method: null,
  meta_data: null,
