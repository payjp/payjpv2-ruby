# PAYJPv2::PaymentIntentCreateRequest
...
| **confirm** | **Boolean** | 「true」に設定すると、このPaymentIntentを直ちに確定しようと試みます。このパラメーターのデフォルトは「false」です。 | [optional][default to false] |
...
instance = PAYJPv2::PaymentIntentCreateRequest.new(
  payment_method: null,
