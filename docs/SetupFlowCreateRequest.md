...
| ---- | ---- | ----------- | ----- |
| **confirm** | **Boolean** | SetupFlow をすぐに確定しようとする場合に &#x60;true&#x60; を設定します。このパラメーターのデフォルト値は &#x60;false&#x60; です。カードが登録済みの支払い方法である場合は、追加の認証が必要な場合に備えて &#x60;return_url&#x60; を指定できます。 | [optional][default to false] |
...
| **payment_method_types** | **Array&lt;String&gt;** |  | [optional] |
