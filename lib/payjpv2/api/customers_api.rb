  ...
  class CustomersApi
    ...
    def get_all_customers_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 100
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomersApi.get_all_customers, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomersApi.get_all_customers, must be greater than or equal to 1.'
      end
    ...
    def get_customer_payment_methods(customer_id, opts = {})
      data, _status_code, _headers = get_customer_payment_methods_with_http_info(customer_id, opts)
      data
    end
    ...
    def get_customer_payment_methods_with_http_info(customer_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomersApi.get_customer_payment_methods ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling CustomersApi.get_customer_payment_methods"
      end
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 100
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomersApi.get_customer_payment_methods, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CustomersApi.get_customer_payment_methods, must be greater than or equal to 1.'
      end
    ...
    def update_customer(customer_id, customer_update_request, opts = {})
      data, _status_code, _headers = update_customer_with_http_info(customer_id, customer_update_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomerResponse, Integer, Hash)>] CustomerResponse data, response status code and response headers
    def update_customer_with_http_info(customer_id, customer_update_request, opts = {})
      if @api_client.config.debugging
