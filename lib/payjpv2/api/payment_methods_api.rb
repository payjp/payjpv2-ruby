...
module PAYJPv2
  class PaymentMethodsApi
    ...
    def attach_payment_method(payment_method_id, payment_method_attach_request, opts = {})
      data, _status_code, _headers = attach_payment_method_with_http_info(payment_method_id, payment_method_attach_request, opts)
      data
    end
    ...
    def attach_payment_method_with_http_info(payment_method_id, payment_method_attach_request, opts = {})
      ...
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.attach_payment_method"
      end
      ...
      if @api_client.config.client_side_validation && payment_method_attach_request.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_attach_request' when calling PaymentMethodsApi.attach_payment_method"
      end
      # resource path
    ...
    def detach_payment_method(payment_method_id, opts = {})
      data, _status_code, _headers = detach_payment_method_with_http_info(payment_method_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PaymentMethodResponse, Integer, Hash)>] PaymentMethodResponse data, response status code and response headers
    def detach_payment_method_with_http_info(payment_method_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentMethodsApi.detach_payment_method ...'
      end
      # verify the required parameter 'payment_method_id' is set
      if @api_client.config.client_side_validation && payment_method_id.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method_id' when calling PaymentMethodsApi.detach_payment_method"
      end
      # resource path
