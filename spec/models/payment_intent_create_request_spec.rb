...
# Unit tests for PAYJPv2::PaymentIntentCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PAYJPv2::PaymentIntentCreateRequest do
  let(:instance) { PAYJPv2::PaymentIntentCreateRequest.new }

  describe 'test an instance of PaymentIntentCreateRequest' do
    it 'should create an instance of PaymentIntentCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PAYJPv2::PaymentIntentCreateRequest)
    end
  end
