...
# Unit tests for PAYJPv2::PaymentIntentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PAYJPv2::PaymentIntentResponse do
  let(:instance) { PAYJPv2::PaymentIntentResponse.new }

  describe 'test an instance of PaymentIntentResponse' do
    it 'should create an instance of PaymentIntentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PAYJPv2::PaymentIntentResponse)
    end
  end
