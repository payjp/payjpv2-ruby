...
# Unit tests for PAYJPv2::RefundResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PAYJPv2::RefundResponse do
  let(:instance) { PAYJPv2::RefundResponse.new }

  describe 'test an instance of RefundResponse' do
    it 'should create an instance of RefundResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PAYJPv2::RefundResponse)
    end
  end
