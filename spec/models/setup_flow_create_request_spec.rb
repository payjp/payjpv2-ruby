...
# Unit tests for PAYJPv2::SetupFlowCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PAYJPv2::SetupFlowCreateRequest do
  let(:instance) { PAYJPv2::SetupFlowCreateRequest.new }

  describe 'test an instance of SetupFlowCreateRequest' do
    it 'should create an instance of SetupFlowCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PAYJPv2::SetupFlowCreateRequest)
    end
  end
