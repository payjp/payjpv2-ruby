...
# Unit tests for PAYJPv2::SetupIntentCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PAYJPv2::SetupIntentCreateRequest do
  let(:instance) { PAYJPv2::SetupIntentCreateRequest.new }
  ...
  describe 'test an instance of SetupIntentCreateRequest' do
    it 'should create an instance of SetupIntentCreateRequest' do
      ...
      #expect(instance).to be_instance_of(PAYJPv2::SetupIntentCreateRequest)
    end
  end
